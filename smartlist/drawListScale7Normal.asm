...
Y_DELAY_HALF        macro    
                    ...
                    endm     
SET_Y_INT           macro    
; it IS better to first set A and THAN B
                    stb      <VIA_port_a                  ; 4 
                    sta      <VIA_port_b                  ; 4 
                    endm     
...
SMVB_continue_yd4_newY_eq_oldX_single:                    ;#isfunction  
                    ...
                    ADD_NOPS  
                    pulu     b,x,pc 
SMVB_continue_yd6_single                                  ;#isfunction  
                    stb      <VIA_port_a                  ; 4 shift not changed, move might also be a draw 
                    sta      <VIA_port_b                  ; 4 
                    Y_DELAY_6                             ; 4 
                    stx      <VIA_port_b                  ; 5 
...
SMVB_continue_yd6_double                                  ;#isfunction  
                    SET_Y_INT  
                    Y_DELAY_6                             ; 4 
                    stx      <VIA_port_b                  ; 5 
                    sta      <VIA_t1_cnt_hi 
...
SMVB_startMove_single:                                    ;#isfunction  
                    ...
                    ADD_NOPS  
                    pulu     b,x,pc 
SMVB_startMove_single_sj_yd4:                             ;#isfunction  
